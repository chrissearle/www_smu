...
ogp:
  og:
    image:
      '': https://www.searle.me.uk/2017/10/03/model-turntable/turntable.jpg
      secure_url: https://www.searle.me.uk/2017/10/03/model-turntable/turntable.jpg
      type: image/jpeg
      width: 1000
      height: 550
    description: 'A small turntable for working with models - assembly, painting and airbrushing'
---
...
<%= fancybox_image('cross-section.png', 'Cross section view') %>
...
<%= fancybox_image('base.jpg', 'The base printed but not yet removed from the build plate') %>
<%= fancybox_image('base-bearing.jpg', 'The base with the bearing pushed into place') %>
<%= fancybox_image('top.jpg', 'The top printed but not yet removed from the build plate') %>
<%= fancybox_image('top-bearing.jpg', 'The top with the bearing pushed into place') %>
<%= fancybox_image('turntable.jpg', 'The turntable finished') %>
