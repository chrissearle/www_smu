...
<%= fancybox_image('river.jpg', 'Skarselva') %>
...
<%= fancybox_image('OyungenDam.jpg', 'Øyungen Dam') %>
...
<%= fancybox_image('OyungenView.jpg', 'Øyungen from above') %>
...
<%= fancybox_image('OyungenPano.jpg', 'Øyungen Panorama') %>
...
<%= fancybox_image('OyungenSunset1.jpg', 'Øyungen Sunset') %>
<%= fancybox_image('OyungenSunset2.jpg', 'Øyungen Sunset') %>
<%= fancybox_image('OyungenSunset3.jpg', 'Øyungen Sunset') %>
