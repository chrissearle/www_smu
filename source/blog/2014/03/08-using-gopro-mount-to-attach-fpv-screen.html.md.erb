...
<%= fancybox_image("modified-gopro-piece.jpg", "Modified gopro piece.") %>
...
<%= fancybox_image("back-of-screen.jpg", "Widen mount point on back of screen.") %>

Next just push the gopro piece in place.

<%= fancybox_image("attachement-in-place.jpg", "Push the gopro piece into place.") %>

And screw it fast.

<%= fancybox_image("attachment-screwed-fast.jpg", "Screwed fast.") %>

Add a gopro j-clip.

<%= fancybox_image("add-gopro-j-clip.jpg", "Add a gopro j-clip.") %>

And then use a standard gopro flat mount to attach it to the radio for use.

<%= fancybox_image("in-place.jpg", "Attach to radio with standard flat mount.") %>

For packing/travel - you can now simply unclip the entire screen.

<%= fancybox_image("detached-for-packing.jpg", "Detached for packing.") %>
