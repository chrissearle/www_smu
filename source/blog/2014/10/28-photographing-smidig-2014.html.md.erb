...
<%= fancybox_image_options("Smidig2014-20141027092624.jpg", "Jim Benson's keynote", {:small => true, :leftright => :left } ) %>
<%= fancybox_image_options("Smidig2014-20141027104625.jpg", "Jim Benson's keynote", {:small => true, :leftright => :right } ) %>
...
<%= fancybox_image_options("Smidig2014-20141027112413.jpg", "Johannes Brodwall", {:small => true, :leftright => :left } ) %>
<%= fancybox_image_options("Smidig2014-20141027131540.jpg", "Ketil Jensen - Lean Coffee", {:small => true, :leftright => :right } ) %>
...
<%= fancybox_image_options("Smidig2014-20141027115455.jpg", "Lunch", {:small => true, :leftright => :right } ) %>
<%= fancybox_image_options("Smidig2014-20141027124914.jpg", "Lunch break", {:small => true, :leftright => :right } ) %>
